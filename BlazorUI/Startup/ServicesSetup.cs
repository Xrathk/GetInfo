...
namespace BlazorUI.Startup
{
    ...
    public static class ServicesSetup
    {
        ...
        {
            services.AddSingleton<IErrorCodes, ErrorCodes>(); // Add error codes
            services.AddTransient<IAccountOperations, AccountOperations>(); // Add account operations service
            services.AddTransient<IWeatherApiOperations, WeatherApiOperations>(); // Add weather API operations service
            services.AddTransient<INewsApiOperations, NewsApiOperations>(); // Add news API operations service
        ...
        {
            services.AddSingleton<OneTimeMethods>(); // No need for interface, need to be applied only once
